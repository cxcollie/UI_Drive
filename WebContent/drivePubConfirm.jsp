...
<!DOCTYPE html>
<html>
<title>Publish Drive Confirmation</title>
...
<div class="w3-container w3-grayscale-min" id="us">
  <div class="w3-content">
    <h1 class="w3-center w3-text-grey"><b>Drive is Published</b></h1>
  </div>
</div>
...
<p class="quote2 w3-center">"You know my fourth rule？Never make a promise you can't keep."</p>
<p class="quote2 w3-center">--The Transporter</p>

</div>

<div class="w3-half" >
<img src="images/bouncercat.png" style="width:100%"/>
</div>
</div>
</body>
